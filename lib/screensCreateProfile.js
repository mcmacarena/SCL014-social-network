// CREATE PROFILE
// desabilita todos los botones desde antes 
...
// funcionalidad cerrar ventana de crear perfiles
...
export const createProfileNext1 = () => {
  ...
  document.querySelector('#back').addEventListener('click', () => {
    //se ejecuta pregunta anterior
    createProfileBegin();
    //oculpa pregunta actual
