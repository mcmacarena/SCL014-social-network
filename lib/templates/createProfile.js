  ...
  `<div id="containerCreateProfile">
    <div id="createProfile">
      ...
      <div id="placesDogQuestion" class="hide questionCreatreProfile">
        ...
        <input class="inputs" type="text" id="placeDog1" placeholder="Lugar 1">
        <input class="inputs" type="text" id="placeDog2" placeholder="Lugar 2">
        <input class="inputs" type="text" id="placeDog3" placeholder="Lugar 3">
