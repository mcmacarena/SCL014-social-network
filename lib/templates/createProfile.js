  ...
  `<div id='containerCreateProfile'>
    <div id='createProfile'>
      ...
      <div id='nameDogQuestion' class='questionCreatreProfile'>
        ...
        <button id='btnCreateProfile1' class='btnContinue' >Siguiente</button>
      </div>
      <div id="sexDogQuestion" class="hide questionCreatreProfile">
        ...
        <button id="btnCreateProfile2" class="btnContinue" >Siguiente</button>
      </div>
      ...
      <div id="personalityDogQuestion" class="hide questionCreatreProfile">
        ...
        <p><input type="checkbox" name="personality" id="personality4" value="Cociable"> Sociable </p>
      ...
      <div id="sexPreferencesDogQuestion" class="hide questionCreatreProfile">
        ...
        <button id='btnCreateProfile12' class='btnContinue'>Siguiente</button>
      </div> 
      <div id='sizePreferencesDogQuestion' class='hide questionCreatreProfile'>
        ...
        <button id='btnCreateProfile13' class='btnContinue' >Siguiente</button>
      </div>
      <div id='personalityPreferencesDogQuestion' class='hide questionCreatreProfile'>
        ...
        <p><input type='checkbox' name='personalityPreference' id='personality4Preference' value='Socibale'> Sociables </p>
        ...
        <button id='btnCreateProfile14' class='btnContinue' >Siguiente</button>
      </div>
      <div id='schedulePreferencesDogQuestion' class='hide questionCreatreProfile'>
        ...
        <button id='btnCreateProfile15' class='btnContinue' >Finalizar</button>
      </div>
